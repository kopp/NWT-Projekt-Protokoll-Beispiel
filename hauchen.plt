...
set terminal png
set output "hauchen.png"

## Last datafile plotted: "hauchen.dat"
plot 'hauchen.dat' u 2:5 w lp axis x1y1 title "Temperatur", '' u 2:8 w lp axis x1y2 title "Luftfeuchte"
#    EOF
